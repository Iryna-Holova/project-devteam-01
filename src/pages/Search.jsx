    ...
    useEffect(() => {
        ...
        setError(null)
            ...
            if (selectedValue === "ingredients" && searchValue !== "") {
                getIngredientsRecipes(searchValue).then(ingr => {
                    setIngredients(ingr); 
                    setStatus('resolved')})
                    .catch(err => {
            ...
            if (selectedValue === "title" && searchValue !== "") {
                getTitleRecipes(searchValue).then(ingr => {
                    setTitle(ingr); 
                    setStatus('resolved')})
                    .catch(err => {
                        setError(err.message); 
...
console.log(ingredients);
    ...
    return <MainTitle>
    <Searchbar setTitles={setTitle} setIngredient={setIngredients} addStatus={setStatus} addError={setError} onSubmit={formOnsubmitHandler}/>
